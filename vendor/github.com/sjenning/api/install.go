...
import (
	...
	"github.com/sjenning/api/apps"
	"github.com/sjenning/api/authorization"
	"github.com/sjenning/api/build"
	"github.com/sjenning/api/config"
	"github.com/sjenning/api/image"
	"github.com/sjenning/api/kubecontrolplane"
	"github.com/sjenning/api/network"
	"github.com/sjenning/api/oauth"
	"github.com/sjenning/api/openshiftcontrolplane"
	"github.com/sjenning/api/operator"
	"github.com/sjenning/api/osin"
	"github.com/sjenning/api/project"
	"github.com/sjenning/api/quota"
	"github.com/sjenning/api/route"
	"github.com/sjenning/api/security"
	"github.com/sjenning/api/servicecertsigner"
	"github.com/sjenning/api/template"
	"github.com/sjenning/api/user"
	"github.com/sjenning/api/webconsole"

	// just make sure this compiles.  Don't add it to a scheme
	_ "github.com/sjenning/api/legacyconfig/v1"
)
