...
import (
	...
	apps "github.com/sjenning/api/apps/v1"
	authorization "github.com/sjenning/api/authorization/v1"
	build "github.com/sjenning/api/build/v1"
	image "github.com/sjenning/api/image/v1"
	network "github.com/sjenning/api/network/v1"
	oauth "github.com/sjenning/api/oauth/v1"
	project "github.com/sjenning/api/project/v1"
	quota "github.com/sjenning/api/quota/v1"
	route "github.com/sjenning/api/route/v1"
	security "github.com/sjenning/api/security/v1"
	template "github.com/sjenning/api/template/v1"
	user "github.com/sjenning/api/user/v1"
)
